...
PACKER_WINDOWS_AGENT_CLEANUP="${ROOT_DIR}/packer/builds/windows/common/scripts/cleanup-security-agents.ps1"
PACKER_LINUX_AGENT_CLEANUP="${ROOT_DIR}/packer/builds/linux/common/scripts/cleanup-security-agents.sh"
...
grep -q 'cleanup-security-agents.ps1' "${PACKER_WINDOWS_2022_TEMPLATE}"
grep -q 'cleanup-security-agents.ps1' "${PACKER_WINDOWS_2025_TEMPLATE}"
grep -q 'placeholder-required' "${PACKER_WINDOWS_AGENT_CLEANUP}"
grep -q 'CrowdStrike Falcon' "${PACKER_WINDOWS_AGENT_CLEANUP}"
grep -q 'Sophos' "${PACKER_WINDOWS_AGENT_CLEANUP}"
grep -q 'cleanup-security-agents.sh' "${PACKER_UBUNTU_TEMPLATE}"
grep -q 'placeholder-required' "${PACKER_LINUX_AGENT_CLEANUP}"
grep -q 'Sophos' "${PACKER_LINUX_AGENT_CLEANUP}"
